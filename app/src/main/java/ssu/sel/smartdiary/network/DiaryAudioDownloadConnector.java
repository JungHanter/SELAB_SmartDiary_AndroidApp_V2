 ...
 */
public class DiaryAudioDownloadConnector {
    ...
    public DiaryAudioDownloadConnector(String apiUrl, String method, OnConnectListener l) {
        this.apiUrl = apiUrl;
            ...
            protected Boolean doInBackground(Void... voids) {
                ...
                try {
                    ...
                    if (resCode == HttpURLConnection.HTTP_OK) {
                        ...
                        File file = GlobalUtils.getDiaryFile(userId, audioDiaryId);
